...
#distinguish the tool from irontools or shears by giving a tag that can later be read:
...
execute if entity @s[scores={vm_diashovel=1..}] run function vein_miner:somethingmined