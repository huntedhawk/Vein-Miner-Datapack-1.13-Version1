...
#distinguish the tool from dia/irontools by giving a tag that can later be read:
...
execute if entity @s[scores={vm_shear=1..}] run function vein_miner:somethingmined