...
#to prevent veinmining if the tool is rightclicked, an additional blockcheck kills it for that case.
...
execute if entity @s[scores={vm_ironaxe=1..}] run function vein_miner:somethingmined