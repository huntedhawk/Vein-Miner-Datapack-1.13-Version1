...
execute if score #vm_randval vm_calc matches 1..2 run scoreboard players remove #vm_unbreak vm_pickus 1

execute if score #vm_unbreak vm_calc < #vm_breakurse vm_pickus run function vein_miner:unbreaking/unbreak2
