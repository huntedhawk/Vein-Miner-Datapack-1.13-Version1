execute if entity @s[scores={vm_pickus=65..}] run summon item ~ ~ ~ {Item:{id:"minecraft:horn_coral_fan",Count:64b},Tags:["vm_hornc"],PickupDelay:1}
execute if entity @s[scores={vm_pickus=65..}] run scoreboard players remove @s vm_pickus 64
execute if entity @s[scores={vm_pickus=..64}] run summon item ~ ~ ~ {Item:{id:"minecraft:horn_coral_fan",Count:1b},Tags:["vm_adjust","vm_hornc"],PickupDelay:1}
...
execute if entity @s[scores={vm_pickus=65..}] run function vein_miner:blocks/oceans/horn_fan/normalitems