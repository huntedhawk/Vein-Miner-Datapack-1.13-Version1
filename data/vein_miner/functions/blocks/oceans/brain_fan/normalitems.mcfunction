execute if entity @s[scores={vm_pickus=65..}] run summon item ~ ~ ~ {Item:{id:"minecraft:brain_coral_fan",Count:64b},Tags:["vm_brainc"],PickupDelay:1}
execute if entity @s[scores={vm_pickus=65..}] run scoreboard players remove @s vm_pickus 64
execute if entity @s[scores={vm_pickus=..64}] run summon item ~ ~ ~ {Item:{id:"minecraft:brain_coral_fan",Count:1b},Tags:["vm_adjust","vm_brainc"],PickupDelay:1}
...
execute if entity @s[scores={vm_pickus=65..}] run function vein_miner:blocks/oceans/brain_fan/normalitems