...
execute if score #vm_randval vm_calc matches 0..624 run scoreboard players add #vm_max vm_calc 1
...
function vein_miner:random/nextrand
execute if score #vm_randval vm_calc matches 0..555 run scoreboard players add #vm_max vm_pickus 1

execute if score @s vm_calc < #vm_cycle vm_pickus run function vein_miner:blocks/leaves/dark_oak/fortune1
