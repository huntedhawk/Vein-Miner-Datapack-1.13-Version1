...
scoreboard players set #vm_maxrand vm_calc 10
...
function vein_miner:random/nextrand
execute if score #vm_randval vm_calc matches 0..832 run scoreboard players add #vm_max vm_pickus 1

execute if score @s vm_calc < #vm_cycle vm_pickus run function vein_miner:blocks/leaves/dark_oak/fortune3
execute if score @s vm_calc >= #vm_cycle vm_pickus run function vein_miner:blocks/leaves/dark_oak/saplingitems