...
execute unless score #vm_frstop vm_calc matches 1 run scoreboard players set #vm_maxrand vm_calc 40
...
execute if score @s vm_calc < #vm_cycle vm_pickus run function vein_miner:blocks/leaves/jungle/saplings1
