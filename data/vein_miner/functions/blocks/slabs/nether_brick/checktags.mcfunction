...
execute if entity @s[scores={vm_material=76}] run function vein_miner:blocks/slabs/nether_brick/normalitems
execute if entity @s[scores={vm_material=101}] run scoreboard players operation @s vm_pickus *= #vm_two vm_pickus
execute if entity @s[scores={vm_material=101}] run function vein_miner:blocks/slabs/nether_brick/normalitems