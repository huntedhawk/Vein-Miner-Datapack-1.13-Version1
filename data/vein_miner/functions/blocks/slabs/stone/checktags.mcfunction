...
execute if entity @s[scores={vm_material=68}] run function vein_miner:blocks/slabs/stone/normalitems
execute if entity @s[scores={vm_material=93}] run scoreboard players operation @s vm_pickus *= #vm_two vm_pickus
execute if entity @s[scores={vm_material=93}] run function vein_miner:blocks/slabs/stone/normalitems