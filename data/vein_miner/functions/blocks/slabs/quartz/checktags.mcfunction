...
execute if entity @s[scores={vm_material=72}] run function vein_miner:blocks/slabs/quartz/normalitems
execute if entity @s[scores={vm_material=97}] run scoreboard players operation @s vm_pickus *= #vm_two vm_pickus
execute if entity @s[scores={vm_material=97}] run function vein_miner:blocks/slabs/quartz/normalitems