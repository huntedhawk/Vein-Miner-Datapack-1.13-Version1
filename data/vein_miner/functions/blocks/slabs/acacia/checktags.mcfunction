...
execute if entity @s[scores={vm_material=85}] run function vein_miner:blocks/slabs/acacia/normalitems
execute if entity @s[scores={vm_material=91}] run scoreboard players operation @s vm_pickus *= #vm_two vm_pickus
execute if entity @s[scores={vm_material=91}] run function vein_miner:blocks/slabs/acacia/normalitems