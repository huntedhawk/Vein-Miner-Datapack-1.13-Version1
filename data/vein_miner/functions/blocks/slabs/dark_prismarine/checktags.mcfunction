...
execute if entity @s[scores={vm_material=80}] run function vein_miner:blocks/slabs/dark_prismarine/normalitems
execute if entity @s[scores={vm_material=105}] run scoreboard players operation @s vm_pickus *= #vm_two vm_pickus
execute if entity @s[scores={vm_material=105}] run function vein_miner:blocks/slabs/dark_prismarine/normalitems