...
execute if entity @s[scores={vm_material=70}] run function vein_miner:blocks/slabs/sandstone/normalitems
execute if entity @s[scores={vm_material=95}] run scoreboard players operation @s vm_pickus *= #vm_two vm_pickus
execute if entity @s[scores={vm_material=95}] run function vein_miner:blocks/slabs/sandstone/normalitems