...
execute if entity @s[scores={vm_material=83}] run function vein_miner:blocks/slabs/birch/normalitems
execute if entity @s[scores={vm_material=89}] run scoreboard players operation @s vm_pickus *= #vm_two vm_pickus
execute if entity @s[scores={vm_material=89}] run function vein_miner:blocks/slabs/birch/normalitems