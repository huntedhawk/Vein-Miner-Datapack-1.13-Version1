...
execute if entity @s[scores={vm_material=73}] run function vein_miner:blocks/slabs/red_sandstone/normalitems
execute if entity @s[scores={vm_material=98}] run scoreboard players operation @s vm_pickus *= #vm_two vm_pickus
execute if entity @s[scores={vm_material=98}] run function vein_miner:blocks/slabs/red_sandstone/normalitems