...
execute if entity @s[scores={vm_material=75}] run function vein_miner:blocks/slabs/cobblestone/normalitems
execute if entity @s[scores={vm_material=100}] run scoreboard players operation @s vm_pickus *= #vm_two vm_pickus
execute if entity @s[scores={vm_material=100}] run function vein_miner:blocks/slabs/cobblestone/normalitems