...
execute if entity @s[tag=vm_sheared] run function vein_miner:blocks/vegetation/dead_bush/normalitems
execute if entity @s[tag=!vm_sheared] run function vein_miner:blocks/vegetation/dead_bush/bush1
kill @s