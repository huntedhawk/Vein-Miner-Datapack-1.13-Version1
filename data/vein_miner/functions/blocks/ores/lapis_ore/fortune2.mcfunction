...
execute unless score #vm_frstop vm_calc matches 1 run scoreboard players set #vm_maxrand vm_calc 20
...
execute if score #vm_randval vm_calc matches 16 run scoreboard players add #vm_max vm_calc 15
execute if score #vm_randval vm_calc matches 17 run scoreboard players add #vm_max vm_calc 17
execute if score #vm_randval vm_calc matches 18 run scoreboard players add #vm_max vm_calc 20
execute if score #vm_randval vm_calc matches 19 run scoreboard players add #vm_max vm_calc 23

scoreboard players operation @s vm_pickus += #vm_max vm_calc 
scoreboard players set #vm_max vm_calc 0

execute if score @s vm_calc < #vm_cycle vm_pickus run function vein_miner:blocks/ores/lapis_ore/fortune2
