...
execute unless score #vm_frstop vm_calc matches 1 run scoreboard players set #vm_maxrand vm_calc 15
...
execute if score #vm_randval vm_calc matches 12 run scoreboard players add #vm_max vm_calc 11
execute if score #vm_randval vm_calc matches 13 run scoreboard players add #vm_max vm_calc 13
execute if score #vm_randval vm_calc matches 14 run scoreboard players add #vm_max vm_calc 15

scoreboard players operation @s vm_pickus += #vm_max vm_calc 
scoreboard players set #vm_max vm_calc 0

execute if score @s vm_calc < #vm_cycle vm_pickus run function vein_miner:blocks/ores/lapis_ore/fortune1
