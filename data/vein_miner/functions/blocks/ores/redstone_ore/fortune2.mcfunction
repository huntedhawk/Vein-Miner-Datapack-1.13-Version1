...
execute if score #vm_randval vm_calc matches 1..2 run scoreboard players add #vm_max vm_calc 4
execute if score #vm_randval vm_calc matches 3..4 run scoreboard players add #vm_max vm_calc 5
...
execute if score @s vm_calc < #vm_cycle vm_pickus run function vein_miner:blocks/ores/redstone_ore/fortune2
