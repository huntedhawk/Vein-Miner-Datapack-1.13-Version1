...
execute if entity @s[tag=vm_silkt] run function vein_miner:blocks/randoms/bookshelf/normalitems
execute if entity @s[tag=!vm_silkt] run scoreboard players operation @s vm_pickus *= #vm_three vm_pickus
execute if entity @s[tag=!vm_silkt] run function vein_miner:blocks/randoms/bookshelf/bookitems