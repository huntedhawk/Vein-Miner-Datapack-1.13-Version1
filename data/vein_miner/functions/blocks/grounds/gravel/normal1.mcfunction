...
execute unless score #vm_frstop vm_calc matches 1 run scoreboard players set #vm_maxrand vm_calc 10
...
execute if score @s vm_calc < #vm_cycle vm_pickus run function vein_miner:blocks/grounds/gravel/normal1
