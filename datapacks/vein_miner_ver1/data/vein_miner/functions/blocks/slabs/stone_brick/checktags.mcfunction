...
execute if entity @s[scores={vm_material=69}] run function vein_miner:blocks/slabs/stone_brick/normalitems
execute if entity @s[scores={vm_material=94}] run scoreboard players operation @s vm_pickus *= #vm_two vm_pickus
execute if entity @s[scores={vm_material=94}] run function vein_miner:blocks/slabs/stone_brick/normalitems