...
execute if entity @s[scores={vm_material=71}] run function vein_miner:blocks/slabs/purpur/normalitems
execute if entity @s[scores={vm_material=96}] run scoreboard players operation @s vm_pickus *= #vm_two vm_pickus
execute if entity @s[scores={vm_material=96}] run function vein_miner:blocks/slabs/purpur/normalitems