...
execute if entity @s[scores={vm_material=77}] run function vein_miner:blocks/slabs/petrified_oak/normalitems
execute if entity @s[scores={vm_material=102}] run scoreboard players operation @s vm_pickus *= #vm_two vm_pickus
execute if entity @s[scores={vm_material=102}] run function vein_miner:blocks/slabs/petrified_oak/normalitems