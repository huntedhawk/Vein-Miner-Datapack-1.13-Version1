...
execute if entity @s[scores={vm_material=81}] run function vein_miner:blocks/slabs/oak/normalitems
execute if entity @s[scores={vm_material=87}] run scoreboard players operation @s vm_pickus *= #vm_two vm_pickus
execute if entity @s[scores={vm_material=87}] run function vein_miner:blocks/slabs/oak/normalitems