...
execute if entity @s[scores={vm_material=86}] run function vein_miner:blocks/slabs/dark_oak/normalitems
execute if entity @s[scores={vm_material=92}] run scoreboard players operation @s vm_pickus *= #vm_two vm_pickus
execute if entity @s[scores={vm_material=92}] run function vein_miner:blocks/slabs/dark_oak/normalitems