...
execute if entity @s[scores={vm_material=79}] run function vein_miner:blocks/slabs/prismarine_brick/normalitems
execute if entity @s[scores={vm_material=104}] run scoreboard players operation @s vm_pickus *= #vm_two vm_pickus
execute if entity @s[scores={vm_material=104}] run function vein_miner:blocks/slabs/prismarine_brick/normalitems