...
execute if entity @s[scores={vm_material=78}] run function vein_miner:blocks/slabs/prismarine/normalitems
execute if entity @s[scores={vm_material=103}] run scoreboard players operation @s vm_pickus *= #vm_two vm_pickus
execute if entity @s[scores={vm_material=103}] run function vein_miner:blocks/slabs/prismarine/normalitems