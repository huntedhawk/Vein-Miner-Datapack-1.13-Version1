...
execute if entity @s[scores={vm_material=82}] run function vein_miner:blocks/slabs/spruce/normalitems
execute if entity @s[scores={vm_material=88}] run scoreboard players operation @s vm_pickus *= #vm_two vm_pickus
execute if entity @s[scores={vm_material=88}] run function vein_miner:blocks/slabs/spruce/normalitems