...
execute if entity @s[scores={vm_material=84}] run function vein_miner:blocks/slabs/jungle/normalitems
execute if entity @s[scores={vm_material=90}] run scoreboard players operation @s vm_pickus *= #vm_two vm_pickus
execute if entity @s[scores={vm_material=90}] run function vein_miner:blocks/slabs/jungle/normalitems