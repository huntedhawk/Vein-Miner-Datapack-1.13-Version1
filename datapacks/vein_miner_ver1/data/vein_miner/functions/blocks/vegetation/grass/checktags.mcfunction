...
execute if entity @s[tag=vm_sheared] run function vein_miner:blocks/vegetation/grass/normalitems
execute if entity @s[tag=!vm_sheared] run function vein_miner:blocks/vegetation/grass/grass1
kill @s