...
execute if entity @s[tag=vm_silkt] run function vein_miner:blocks/materials/snow_block/normalitems
execute if entity @s[tag=!vm_silkt] run scoreboard players operation @s vm_pickus *= #vm_four vm_pickus
execute if entity @s[tag=!vm_silkt] run function vein_miner:blocks/materials/snow_block/ballitems