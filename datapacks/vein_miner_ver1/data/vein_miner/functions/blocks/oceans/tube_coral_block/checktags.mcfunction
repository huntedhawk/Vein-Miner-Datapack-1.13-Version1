...
execute if entity @s[tag=vm_silkt] run function vein_miner:blocks/oceans/tube_coral_block/normalitems
execute if entity @s[tag=!vm_silkt] run function vein_miner:blocks/oceans/dead_tube_coral_block/normalitems