...
execute if score #vm_randval vm_calc matches 3 run scoreboard players add #vm_max vm_pickus 4 

scoreboard players operation @s vm_pickus += #vm_max vm_pickus 
scoreboard players set #vm_max vm_pickus 0

execute if score @s vm_calc < #vm_cycle vm_pickus run function vein_miner:blocks/oceans/sea_lantern/fortune2
