...
execute if entity @s[scores={vm_material=367}] run function vein_miner:blocks/crops/cocoa/normalitems
execute if entity @s[scores={vm_material=373}] run scoreboard players operation @s vm_pickus *= #vm_three vm_pickus
execute if entity @s[scores={vm_material=373}] run function vein_miner:blocks/crops/cocoa/normalitems
kill @s