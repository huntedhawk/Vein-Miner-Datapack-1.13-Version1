...
execute if score #vm_randval vm_calc matches 5 run scoreboard players add #vm_max vm_calc 5

scoreboard players operation @s vm_pickus += #vm_max vm_calc 
scoreboard players set #vm_max vm_calc 0

execute if score @s vm_calc < #vm_cycle vm_pickus run function vein_miner:blocks/crops/carrots/fortune2
execute if score @s vm_calc >= #vm_cycle vm_pickus run function vein_miner:blocks/crops/carrots/normalitems