...
execute if score #vm_randval vm_calc matches 4 run scoreboard players add #vm_max vm_calc 3

scoreboard players operation @s vm_pickus += #vm_max vm_calc 
scoreboard players set #vm_max vm_calc 0

execute if score @s vm_calc < #vm_cycle vm_pickus run function vein_miner:blocks/ores/diamond_ore/fortune3
