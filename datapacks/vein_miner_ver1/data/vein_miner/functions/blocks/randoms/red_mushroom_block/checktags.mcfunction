...
execute if entity @s[tag=vm_silkt] run function vein_miner:blocks/randoms/red_mushroom_block/normalitems
execute if entity @s[tag=!vm_silkt] run function vein_miner:blocks/randoms/red_mushroom_block/shrooms1 
kill @s