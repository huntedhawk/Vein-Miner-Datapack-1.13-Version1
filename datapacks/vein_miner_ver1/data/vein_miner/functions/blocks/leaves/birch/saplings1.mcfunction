...
execute if score @s vm_calc < #vm_cycle vm_pickus run function vein_miner:blocks/leaves/birch/saplings1
execute if score @s vm_calc >= #vm_cycle vm_pickus run function vein_miner:blocks/leaves/birch/saplingitems