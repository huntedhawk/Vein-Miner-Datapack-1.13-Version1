...
execute if entity @s[tag=vm_silkt] run function vein_miner:blocks/leaves/birch/normalitems
execute if entity @s[tag=vm_neither] run function vein_miner:blocks/leaves/birch/saplings1
execute if entity @s[tag=vm_fortune3] run function vein_miner:blocks/leaves/birch/fortune3
execute if entity @s[tag=vm_fortune2] run function vein_miner:blocks/leaves/birch/fortune2
execute if entity @s[tag=vm_fortune1] run function vein_miner:blocks/leaves/birch/fortune1
kill @s