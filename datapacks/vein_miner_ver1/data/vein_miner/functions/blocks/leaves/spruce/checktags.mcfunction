...
execute if entity @s[tag=vm_silkt] run function vein_miner:blocks/leaves/spruce/normalitems
execute if entity @s[tag=vm_neither] run function vein_miner:blocks/leaves/spruce/saplings1
execute if entity @s[tag=vm_fortune3] run function vein_miner:blocks/leaves/spruce/fortune3
execute if entity @s[tag=vm_fortune2] run function vein_miner:blocks/leaves/spruce/fortune2
execute if entity @s[tag=vm_fortune1] run function vein_miner:blocks/leaves/spruce/fortune1
kill @s