...
execute if score #vm_randval vm_calc matches 1..2 run scoreboard players add #vm_max vm_pickus 2 
execute if score #vm_randval vm_calc matches 3..4 run scoreboard players add #vm_max vm_pickus 3 

scoreboard players operation @s vm_pickus += #vm_max vm_pickus 
scoreboard players set #vm_max vm_pickus 0

execute if score @s vm_calc < #vm_cycle vm_pickus run function vein_miner:blocks/dimensionblocks/glowstone/fortune1
